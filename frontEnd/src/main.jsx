...
const ListTeachers = lazy (()=> import("./pages/admin/ListTeachers.jsx"));
const DatesTeacher = lazy (()=> import("./pages/admin/DatesTeacher.jsx"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'datosprofesor/:id', element:<DatesTeacher/>}
    ],
  },
  {
    path: "admin",
