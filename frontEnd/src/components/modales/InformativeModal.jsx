    ...
    return (
        <Dialog open={isOpen} onClose={onClose} static={true}>
            <DialogPanel className="flex flex-col gap-8 items-center lg:items-start max-w-[800px] w-full py-[40px] px-[30px]">
                <h1 className="text-title text-darkBlue">{txtmodal}</h1>
                <div className={`grid grid-cols-1 lg:grid-cols-${cols} lg:gap-x-[30px] gap-y-[20px] items-center justify-center`}>
                    {children}
                </div>
