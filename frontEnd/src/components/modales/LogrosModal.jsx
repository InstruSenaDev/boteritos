        ...
        >
          ...
          >
            ...
            {!isConfirm ? (
              <>
                <div
                  className="w-full text-title font-cocogooseRegular text-darkBlue text-center"
                >
                  <h1>{txtmodal}</h1>
                </div>

                <div
                  className="w-full grid grid-cols-1 lg:grid-cols-1 lg:gap-x-[30px] gap-y-[20px] place-items-center text-justify"
                >
                  {children}
                </div>
