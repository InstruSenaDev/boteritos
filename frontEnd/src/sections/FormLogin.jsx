...
export const FormLogin = () => {
  ...
  const defLogin = (dataResponse) => {
    ...
    localStorage.setItem("dataUser", JSON.stringify(dataResponse.data.data));
    localStorage.setItem("token", JSON.stringify(dataResponse.data.token));
    //Obtencion de datos de la URL para la creacion de la redireccion
    let rol = dataResponse.data.data.idrol;
