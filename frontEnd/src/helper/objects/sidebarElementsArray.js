export const sidebarsection = {
  1: [
    ...
    { icon: "fa-solid fa-trophy", texto: "Logros", link: "" },
    { icon: "fa-solid fa-user-plus", texto: "Crear usuario", link: "admin/registro" },
    { icon: "fa-solid fa-plus", texto: "Crear trimestre", link: "" },
    { icon: "fa-solid fa-lock", texto: "Cambiar contraseña", link: "admin/ayudacontrasena" },
  ],
  2: [
    ...
    { icon: "fa-solid fa-lock", texto: "Cambiar contraseña", link: "profesor/ayudacontrasena" },
  ],
  3: [
    { icon: "fa-solid fa-user", texto: "Perfil", link: "estudiante/perfil" },
    { icon: "fa-solid fa-file-lines", texto: "Informes", link: "" },
    { icon: "fa-solid fa-lock", texto: "Cambiar contraseña", link: "estudiante/ayudacontrasena" },
  ],
};
